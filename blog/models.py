...
class Category(models.Model):
    ...
    Each category has a unique name and a corresponding slug.

    Attributes:
        name (CharField): The name of the category. Must be unique.
        slug (SlugField): A slugified version of the category name.
        It's used in URLs.
    """
    ...
    def save(self, *args, **kwargs):
        """
        Overrides the default save method to automatically
        generate a slug from the category name if not provided.
        """
        if not self.slug:
    ...
    class Meta:
        ...
        Attributes:
            verbose_name_plural (str): The plural name for the category.
