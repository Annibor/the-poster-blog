...
def starting_page(request):
    ...
    Retrieves the most recent blog post from the database, truncates
    its content to the first 45 words,
    and passes both the post object and the truncated
    content to the 'home/index.html' template
